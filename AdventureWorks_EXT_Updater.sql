/****** Object:  StoredProcedure [dbo].[AdventureWorksUpdate_EXT] 
   Copyright 2018 Just-BI BV, Raid Fikri (raid.fikri@just-bi.nl)
   Changes for AdventureWorksDW2016_EXT 26 Jan 2019 PBI Lab, Luca Gualtieri (luca.gualtieri@pbilab.com) - line 186 and 279*/
...
CREATE PROCEDURE [dbo].[AdventureWorksUpdate_EXT]
AS
	BEGIN
	...
	/*PBI Lab, Luca Gualtieri (luca.gualtieri@pbilab.com) changes for AdventureWorksDW2016_EXT*/
	ALTER TABLE [dbo].[FactResellerSalesXL_CCI] DROP CONSTRAINT [FK_FactResellerSalesXL_CCI_DimDate]
	ALTER TABLE [dbo].[FactResellerSalesXL_CCI] DROP CONSTRAINT [FK_FactResellerSalesXL_CCI_DimDate1]
	ALTER TABLE [dbo].[FactResellerSalesXL_CCI] DROP CONSTRAINT [FK_FactResellerSalesXL_CCI_DimDate2]
	ALTER TABLE [dbo].[FactResellerSalesXL_PageCompressed] DROP CONSTRAINT [FK_FactResellerSalesXL_PageCompressed_DimDate]
	ALTER TABLE [dbo].[FactResellerSalesXL_PageCompressed] DROP CONSTRAINT [FK_FactResellerSalesXL_PageCompressed_DimDate1]
	ALTER TABLE [dbo].[FactResellerSalesXL_PageCompressed] DROP CONSTRAINT [FK_FactResellerSalesXL_PageCompressed_DimDate2]
	/*end of changes for AdventureWorksDW2016_EXT*/
	...
	/*PBI Lab, Luca Gualtieri (luca.gualtieri@pbilab.com) changes for AdventureWorksDW2016_EXT*/
	ALTER TABLE [dbo].[FactResellerSalesXL_CCI] WITH NOCHECK ADD CONSTRAINT [FK_FactResellerSalesXL_CCI_DimDate] FOREIGN KEY([OrderDateKey]) REFERENCES [dbo].[DimDate] ([DateKey]);
	ALTER TABLE [dbo].[FactResellerSalesXL_CCI] WITH NOCHECK ADD CONSTRAINT [FK_FactResellerSalesXL_CCI_DimDate1] FOREIGN KEY([DueDateKey]) REFERENCES [dbo].[DimDate] ([DateKey]);
	ALTER TABLE [dbo].[FactResellerSalesXL_CCI] WITH NOCHECK ADD CONSTRAINT [FK_FactResellerSalesXL_CCI_DimDate2] FOREIGN KEY([ShipDateKey]) REFERENCES [dbo].[DimDate] ([DateKey]);
	ALTER TABLE [dbo].[FactResellerSalesXL_PageCompressed] WITH NOCHECK ADD CONSTRAINT [FK_FactResellerSalesXL_PageCompressed_DimDate] FOREIGN KEY([OrderDateKey]) REFERENCES [dbo].[DimDate] ([DateKey]);
	ALTER TABLE [dbo].[FactResellerSalesXL_PageCompressed] WITH NOCHECK ADD CONSTRAINT [FK_FactResellerSalesXL_PageCompressed_DimDate1] FOREIGN KEY([DueDateKey]) REFERENCES [dbo].[DimDate] ([DateKey]);
	ALTER TABLE [dbo].[FactResellerSalesXL_PageCompressed] WITH NOCHECK ADD CONSTRAINT [FK_FactResellerSalesXL_PageCompressed_DimDate2] FOREIGN KEY([ShipDateKey]) REFERENCES [dbo].[DimDate] ([DateKey]);
	/*end of changes for AdventureWorksDW2016_EXT*/
